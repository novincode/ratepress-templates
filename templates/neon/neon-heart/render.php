...
<div class="ratekit-widget ratekit-neon-heart<?php echo esc_attr( $is_js_mode ? ' ratekit-js-mode' : '' ); ?>"<?php echo esc_attr( $theme === 'dark' ? ' data-theme="dark"' : '' ); ?>
     data-object-id="<?php echo esc_attr($object_id); ?>"
     data-object-type="<?php echo esc_attr($object_type); ?>"
     data-category="binary"
     data-template="neon/neon-heart"
     data-size="<?php echo esc_attr($size); ?>"
     role="group"
     aria-label="<?php esc_attr_e('Neon Heart rating widget', 'ratekit'); ?>">
     
    <button class="heart-btn <?php echo esc_attr( $is_loved ? 'active' : '' ); ?>" 
            type="button"
            data-value="1"
